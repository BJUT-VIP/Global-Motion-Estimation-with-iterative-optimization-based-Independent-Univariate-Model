...
if __name__ == '__main__':
    # file_name = r'G:\new\flo_data\nbaa\nba_1\5\1980.npy'
    file_name = r'D:\code\yz_job\code\15456.npy'
    print(file_name)
    ...
    resize_w = 98  # ncaa 128, ucf 32
    resize_h = 72  # ncaa 72, ucf 24
    ...
    # local motion further refinement (optional)
